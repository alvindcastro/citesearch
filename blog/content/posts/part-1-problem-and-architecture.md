---
title: "Building CiteSearch, Part 1: The Problem Nobody Talks About"
date: 2026-03-24
description: "Every Banner upgrade ships a PDF. Someone has to read it. What if they didn't have to? This is the story of how CiteSearch started — the pain point, the idea, and the architecture that emerged from a whiteboard session."
tags: ["go", "rag", "ai", "azure", "architecture", "ellucian-banner"]
series: ["CiteSearch"]
cover:
  image: ""
  alt: "Architecture diagram of the CiteSearch RAG pipeline"
  relative: false
showToc: true
TocOpen: false
draft: false
